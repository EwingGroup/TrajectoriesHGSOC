...
# run this via qsub -t 1-n run_STAR-Fusion_MDA.sh 
...
datadir=/exports/igmm/eddie/HGS-OvarianCancerA-SGP-WGS/fusions/MDA_fastq_merged
SAMPLELIST=/exports/igmm/eddie/HGS-OvarianCancerA-SGP-WGS/fusions/MDA_ids.list
...
STAR-Fusion --genome_lib_dir $CTAT_GENOME_LIB \
	...
	--output_dir MDA_results/$sampleID
