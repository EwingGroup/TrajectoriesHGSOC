...
myfilters=(ffpm mantasv mantap lumpysv lumpyp gridss gridssp)

echo "FusionName filtered.FFPM MantaSV MantaSVpass LumpySV LumpySVpass Gridss GridssPass" | tr ' ' '\t' > $OUTPUT
