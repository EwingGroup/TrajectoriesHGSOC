...
# run this via qsub -t 1-n run_STAR-Fusion_SHGSOC.sh 
...
datadir=/exports/igmm/eddie/HGS-OvarianCancerA-SGP-WGS/rnaseq/raw_reads/SHGSOC/renamed_merged
SAMPLELIST=/exports/igmm/eddie/HGS-OvarianCancerA-SGP-WGS/fusions/SHGSOC_usable_ids.txt
...
STAR-Fusion --genome_lib_dir $CTAT_GENOME_LIB \
	...
	--output_dir SHGSOC_results/$sampleID
