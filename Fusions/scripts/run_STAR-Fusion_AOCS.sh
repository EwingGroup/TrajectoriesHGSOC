...
# run this via qsub -t 1-n run_STAR-Fusion_AOCS.sh 
...
datadir=/exports/igmm/eddie/HGS-OvarianCancerA-SGP-WGS/fusions/AOCS_fastq_merged
SAMPLELIST=/exports/igmm/eddie/HGS-OvarianCancerA-SGP-WGS/fusions/AOCS_rerun_ids.list
...
STAR-Fusion --genome_lib_dir $CTAT_GENOME_LIB \
	...
	--output_dir AOCS_results/$sampleID
